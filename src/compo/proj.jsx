...
{return(<div class="pt-2"><Crds 
         url={projectarry.url}
         dis="this is our first project"
         /></div>
    )
}
  ...
  return (
    <div>
      ...
      <div class="flex flex-col items-center justify-center pt-8  ">
        <div class="border-2 flex h-coustomh w-3/4 bg-gradient-to-br from-blue-400 to-emerald-400 ">
         <div class="pt-2">{projectarry.map(CardCreation)}</div>
