...
export default function Projects(props) {
  return (
    <div>
      ...
      <p class="text-white text-5xl pl-5 "> Types of Projects</p>
      <p class="text-white text-5xl pl-5 ">we have worked on.</p>
      <div class="flex flex-col items-center justify-center pt-8  ">
        <div class="border-2   w-3/4 bg-gradient-to-br from-blue-400 to-emerald-400  ">
          {projectarry.map(CardCreation)}
